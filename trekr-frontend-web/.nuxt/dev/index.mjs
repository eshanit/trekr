...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, deleteCookie, parseCookies, setCookie, readBody, createError, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, getQuery as getQuery$1, getResponseStatusText } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/devalue/index.js';
import { renderSSRHead } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/radix3/dist/index.mjs';
import { nanoid } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/nanoid/index.js';
import dayjs from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/dayjs/dayjs.min.js';
import sessionDriver from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/unstorage/drivers/memory.mjs';
import * as argon2 from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/argon2/argon2.js';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/pathe/dist/index.mjs';
import { version, unref } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "nestServerUrl": "http://localhost:8000"
  },
  "session": {
    "isEnabled": true,
    "session": {
  ...
  "ipx": {
    ...
    "alias": {},
    "fs": {
      "dir": "C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/public"
    },
    "http": {
      "domains": []
    }
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\Admin\\Documents\\Projects\\Tinashe\\trekr\\trekr-frontend-web","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\Admin\\Documents\\Projects\\Tinashe\\trekr\\trekr-frontend-web\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\Admin\\Documents\\Projects\\Tinashe\\trekr\\trekr-frontend-web\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\Admin\\Documents\\Projects\\Tinashe\\trekr\\trekr-frontend-web\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\Admin\\Documents\\Projects\\Tinashe\\trekr\\trekr-frontend-web\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _WUCAzNXV4T = (function(nitro) {
...
const _xJ5cgVqmjF = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _k2t39A = eventHandler(async (event) => {
...
const _0V0LF2 = eventHandler(async (event) => {
...
const _EZgVlI = eventHandler(async (event) => {
  await deleteSession(event);
  return null;
});

const _mXQ6R1 = eventHandler((event) => event.context.session);

const _OKlPOi = eventHandler(async (event) => {
  const body = await readBody(event);
  if (checkIfObjectAndContainsIllegalKeys(body)) {
    throw createError({ statusCode: 400, message: "Trying to pass invalid data to session, likely an object with `id` or `createdAt` fields or a non-object" });
  }
...
const _R4stcD = lazyEventHandler(() => {
...
const _lazy_KM6AkF = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_KM6AkF, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _k2t39A, lazy: false, middleware: true, method: undefined },
  { route: '/api/session', handler: _0V0LF2, lazy: false, middleware: false, method: "patch" },
  { route: '/api/session', handler: _EZgVlI, lazy: false, middleware: false, method: "delete" },
  { route: '/api/session', handler: _mXQ6R1, lazy: false, middleware: false, method: "get" },
  { route: '/api/session', handler: _OKlPOi, lazy: false, middleware: false, method: "post" },
  { route: '/_ipx/**', handler: _R4stcD, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_KM6AkF, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/Admin/Documents/Projects/Tinashe/trekr/trekr-frontend-web/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
