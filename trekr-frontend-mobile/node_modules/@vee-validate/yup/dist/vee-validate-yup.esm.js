...
function getDescriptionFromYupDescription(desc) {
    var _a;
    if ('tests' in desc) {
        const required = ((_a = desc === null || desc === void 0 ? void 0 : desc.tests) === null || _a === void 0 ? void 0 : _a.some(t => t.name === 'required')) || false;
        return {
            required,
            exists: true,
        };
...
function getDescriptionForPath(path, schema) {
    if (!isObjectSchema(schema)) {
        return null;
    }
    if (isNotNestedPath(path)) {
        const field = schema.fields[cleanupNonNestedPath(path)];
        return (field === null || field === void 0 ? void 0 : field.describe()) || null;
    }
